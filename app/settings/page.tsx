        ...
        <main className="p-6">
          <div className="mx-auto max-w-2xl space-y-6">
            ...
            <Card className="border-slate-700 bg-slate-800">
              <CardHeader>
                <CardTitle className="text-white">HeyReach Integration</CardTitle>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="heyreach-key" className="text-slate-300">
                    API Key
                  </Label>
                  <Input
                    id="heyreach-key"
            ...
            <Card className="border-slate-700 bg-slate-800">
              <CardHeader>
                <CardTitle className="text-white">Smartlead Integration</CardTitle>
                <CardDescription className="text-slate-400">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="smartlead-key" className="text-slate-300">
                    API Key
                  </Label>
                  <Input
                    id="smartlead-key"
            ...
            <Card className="border-slate-600 bg-slate-700/50">
              <CardContent className="pt-6">
                ...
                <ul className="mt-3 space-y-2 text-sm text-slate-400">
                  <li>
                    <strong className="text-slate-300">HeyReach:</strong> Go to
                    Settings → Integrations → API in your HeyReach dashboard
                  </li>
                  <li>
                    <strong className="text-slate-300">Smartlead:</strong> Go to
