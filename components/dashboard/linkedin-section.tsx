...
export function LinkedInSection({
  ...
  const acceptRate = totals.invitesSent > 0
    ? ((totals.invitesAccepted / totals.invitesSent) * 100).toFixed(1) : "0";

  const replyRate = totals.invitesAccepted > 0
    ? ((totals.repliesReceived / totals.invitesAccepted) * 100).toFixed(1) : "0";
